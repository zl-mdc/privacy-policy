 ...
 * @LastEditTime: 2021-06-10 20:34:53
 * @LastEditors: myjdml
...
<template>
    <div id="info">
          ...
          <p style="text-align: center;font-size: 12px;line-height: 1;">更新时间：2021年9月20日</p>
          <p style="text-align: center;font-size: 12px;line-height: 1;">生效时间：2021年9月23日</p>
          ...
          <h3>您提供的信息</h3>
          <p>您在注册或登陆账户或使用我们的服务时，向我们提供的相关个人信息，例如电话号码、身份证号、电子邮件或银行卡号等；</p>
          <p>您通过我们的服务向其他方提供的共享信息，以及您使用我们的服务时所储存的信息。</p>
          <h3>其他方分享的您的信息</h3>
          <p>其他方使用我们的服务时所提供有关您的共享信息。</p>
          <h3>我们获取的您的信息</h3>
          <p>您使用服务时我们可能收集如下信息：</p>
          <p>日志信息，指您使用我们的服务时，系统可能自动采集的技术信息，包括：设备或软件信息，例如您的移动设备、网页浏览器或用于接入我们服务的其他程序所提供的配置信息、您的IP地址和移动设备所用的版本和设备识别码；</p>
          ...
          <p>位置信息、MAC地址信息，指您开启设备定位功能并使用我们基于位置提供的相关服务时，收集的有关您位置的信息，包括：</p>
          <ul>
          ...
          <ul>
              ...
              <li>向您提供与您更加相关的广告以替代普遍投放的广告；评估我们服务中的广告和其他促销及推广活动的效果，并加以改善；软件认证或管理软件升级；让您参与有关我们产品和服务的调查。</li>
          </ul>
          ...
          <h2>您分享的敏感个人信息  </h2>
          <p>某些个人信息因其特殊性可能被认为是敏感个人信息，例如您的身份证号、种族、宗教、个人健康和医疗信息等。相比其他个人信息，敏感个人信息受到更加严格的保护。</p>
          ...
          <h3>第三方SDK</h3>
          <p>本App内集成了：阿里ARouter、友盟Umeng、腾讯Bugly、QQ开放平台共四个第三方SDK，以便于更好的为您服务。</p>
          <p>其功能分别为：</p>
          <ul>
            <li> 阿里ARouter：负责App内的跨模块跳转和跨模块通信。</li>
            <li> 友盟Umeng：负责App内的消息推送和版本分布、收集当日活跃用户等App信息以便于优化服务。</li>
            <li> 腾讯Bugly：负责App内的报错信息收集，方便锁定线上问题，及时修复产品。</li>
            <li> QQ开放平台：负责App内的内容分享至站外平台，从“邮圈”分享至QQ好友与QQ空间。</li>
          </ul>

          <h3>APP自启动和关联启动</h3>
          <p>APP集成的SDK（腾讯Bugly、阿里Arouter 友盟）会出现关联启动的现象，其目的是为了收集错误信息、收集版本分布和用户日活，消息推送等功能。</p>

          <h3>定向推送功能</h3>
          <p>APP内集成了友盟推送，可以针对用户推送消息，其目的是为了对使用产品服务中需要提醒用户的内容进行通知推送（如待办事项的提醒）。</p>

          <h3>超范围收集个人信息</h3>
          <p>APP内集成的第三方SDK（阿里Arouter、腾讯Bugly）可能存在超范围收集用户信息的情况（用户MAC地址、身份证号等）。</p>
          ...
          <p>除本《隐私政策》另有规定外，本《隐私条款》所用词语将与《其明服务协议》所定义的词语具有相同的涵义。</p>
